...
if __name__ == '__main__':
    ...
    parser.add_argument("-source_root", "--source_root", help="specify your source dir",
                        default="/media/hyo/文档/Cross_Resolution_Dataset/CelebAMask-HQ-CR/CelebAMask-HQ-CR/lfw", type=str)
    parser.add_argument("-dest_root", "--dest_root", help="specify your destination dir",
                        default="/media/hyo/文档/Cross_Resolution_Dataset/CelebAMask-HQ-CR/CelebAMask-HQ-CR/lfw_aligned", type=str)
    ...
    #
    #     parsing_name = image_name.split('.')[0].zfill(5) + '.png'
    #     img = Image.open(os.path.join(parsing_root, parsing_name)).resize((1024, 1024))
    #     warped_face = warp_and_crop_face(np.array(img), facial5points, reference, crop_size=(crop_size, crop_size))
    #     img_warped = Image.fromarray(warped_face[0])
    #     img_warped.save(os.path.join(target_parsing_root, parsing_name))
