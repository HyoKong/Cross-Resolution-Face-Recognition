...
if __name__ == '__main__':
    ...
    parser.add_argument("-source_root", "--source_root", help = "specify your source dir", default = "/media/hyo/文档/VIS-NIR/colorferet/VIS/", type = str)
    parser.add_argument("-dest_root", "--dest_root", help = "specify your destination dir", default = "/media/hyo/文档/VIS-NIR/colorferet/VIS_aligned/", type = str)
    ...
    for image_name in tqdm(os.listdir(source_root)):
        ...
        # if not os.path.exists(os.path.join(dest_root,image_name.split('.')[0])):
        #     os.makedirs(os.path.join(dest_root,image_name.split('.')[0]))
